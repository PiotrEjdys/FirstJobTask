...
export class BookService{
  bookId: number =4;
    ...
    private books: Book[] = [
        new Book('12345678923','title1','author1',['cat1','cat2'],200,'1995-02-11',1),
        new Book('12345678923','title2','author2',['cat3','cat2'],250,'1994-03-10',2),
        new Book('12345678923','title3','author3',['cat1','cat4'],300,'2000-04-05',3)
      ];
    getBooks(){
